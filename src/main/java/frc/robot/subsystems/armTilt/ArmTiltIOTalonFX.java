...
public class ArmTiltIOTalonFX implements ArmTiltIO {
    ...
    private final LoggedTunableNumber mTunableKG = new LoggedTunableNumber("ArmTilt/kG", kG);
    private final LoggedTunableNumber mTunableKS = new LoggedTunableNumber("ArmTilt/kS", kS);
    private final LoggedTunableNumber mTunableKV = new LoggedTunableNumber("ArmTilt/kV", kV);
    private final LoggedTunableNumber mTunableKA = new LoggedTunableNumber("ArmTilt/kA", kA);
    private final LoggedTunableNumber mTunableKP = new LoggedTunableNumber("ArmTilt/kP", kP);
    private final LoggedTunableNumber mTunableKI = new LoggedTunableNumber("ArmTilt/kI", kI);
    private final LoggedTunableNumber mTunableKD = new LoggedTunableNumber("ArmTilt/kD", kD);
    
    private final LoggedTunableNumber mTunableMagicVel = new LoggedTunableNumber("ArmTilt/MagicVelocity", kMagicVel);
    private final LoggedTunableNumber mTunableMagicAccel = new LoggedTunableNumber("ArmTilt/MagicAcceleration", kMagicAccel);
    private final LoggedTunableNumber mTunableMagicJerk = new LoggedTunableNumber("ArmTilt/MagicJerk", kMagicJerk);
    
    public ArmTiltIOTalonFX() {
        ...
        mConfig.Feedback.SensorToMechanismRatio = 110.73;
