...
public class AutoScoreShooterSubwoofer extends SequentialCommandGroup {
    public AutoScoreShooterSubwoofer(Drive drive, Indexer indexer, ShooterTilt tilt, Flywheels flywheels, ObjectiveTracker objective, BooleanSupplier scoreOverride) {
        addCommands(
