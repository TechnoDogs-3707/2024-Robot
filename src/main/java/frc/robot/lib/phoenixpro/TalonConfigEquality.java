...
public class TalonConfigEquality {
    ...
    public static boolean isEqual(Slot0Configs a, Slot0Configs b) {
        boolean val = PoofsUtil.epsilonEquals(a.kP,b.kP,TALON_CONFIG_EPSILON) &&
                PoofsUtil.epsilonEquals(a.kI,b.kI,TALON_CONFIG_EPSILON) &&
                PoofsUtil.epsilonEquals(a.kD,b.kD,TALON_CONFIG_EPSILON) &&
                PoofsUtil.epsilonEquals(a.kV,b.kV,TALON_CONFIG_EPSILON) &&
                PoofsUtil.epsilonEquals(a.kS,b.kS,TALON_CONFIG_EPSILON);
    ...
    public static boolean isEqual(MotorOutputConfigs a, MotorOutputConfigs b) {
        boolean val = a.Inverted.value == b.Inverted.value
                ...
                && PoofsUtil.epsilonEquals(a.DutyCycleNeutralDeadband, b.DutyCycleNeutralDeadband,TALON_CONFIG_EPSILON)
                && PoofsUtil.epsilonEquals(a.PeakForwardDutyCycle, b.PeakForwardDutyCycle,TALON_CONFIG_EPSILON)
                && PoofsUtil.epsilonEquals(a.PeakReverseDutyCycle, b.PeakReverseDutyCycle,TALON_CONFIG_EPSILON);
        if (ENABLE_LOGGING_INEQ && !val) {
    ...
    public static boolean isEqual(CurrentLimitsConfigs a, CurrentLimitsConfigs b) {
        boolean val = PoofsUtil.epsilonEquals(a.StatorCurrentLimit, b.StatorCurrentLimit,TALON_CONFIG_EPSILON)
                && PoofsUtil.epsilonEquals(a.SupplyCurrentLimit, b.SupplyCurrentLimit,TALON_CONFIG_EPSILON)
    ...
    public static boolean isEqual(VoltageConfigs a, VoltageConfigs b) {
        boolean val = PoofsUtil.epsilonEquals(a.SupplyVoltageTimeConstant, b.SupplyVoltageTimeConstant,TALON_CONFIG_EPSILON)
                && PoofsUtil.epsilonEquals(a.PeakForwardVoltage, b.PeakForwardVoltage)
                && PoofsUtil.epsilonEquals(a.PeakReverseVoltage, b.PeakReverseVoltage);
        if (ENABLE_LOGGING_INEQ && !val) {
    ...
    public static boolean isEqual(TorqueCurrentConfigs a, TorqueCurrentConfigs b) {
        boolean val = PoofsUtil.epsilonEquals(a.PeakForwardTorqueCurrent, b.PeakForwardTorqueCurrent,TALON_CONFIG_EPSILON)
                && PoofsUtil.epsilonEquals(a.PeakReverseTorqueCurrent, b.PeakReverseTorqueCurrent,TALON_CONFIG_EPSILON)
                && PoofsUtil.epsilonEquals(a.TorqueNeutralDeadband, b.TorqueNeutralDeadband,TALON_CONFIG_EPSILON);
        if (ENABLE_LOGGING_INEQ && !val) {
    ...
    public static boolean isEqual(FeedbackConfigs a, FeedbackConfigs b) {
        boolean val = PoofsUtil.epsilonEquals(a.FeedbackRotorOffset, b.FeedbackRotorOffset,TALON_CONFIG_EPSILON)
                && PoofsUtil.epsilonEquals(a.SensorToMechanismRatio, b.SensorToMechanismRatio,TALON_CONFIG_EPSILON)
                && PoofsUtil.epsilonEquals(a.RotorToSensorRatio, b.RotorToSensorRatio,TALON_CONFIG_EPSILON)
    ...
    public static boolean isEqual(OpenLoopRampsConfigs a, OpenLoopRampsConfigs b) {
        boolean val = PoofsUtil.epsilonEquals(a.DutyCycleOpenLoopRampPeriod, b.DutyCycleOpenLoopRampPeriod,TALON_CONFIG_EPSILON)
                && PoofsUtil.epsilonEquals(a.VoltageOpenLoopRampPeriod, b.VoltageOpenLoopRampPeriod,TALON_CONFIG_EPSILON)
                && PoofsUtil.epsilonEquals(a.TorqueOpenLoopRampPeriod, b.TorqueOpenLoopRampPeriod,TALON_CONFIG_EPSILON);
        if (ENABLE_LOGGING_INEQ && !val) {
    ...
    public static boolean isEqual(ClosedLoopRampsConfigs a, ClosedLoopRampsConfigs b) {
        boolean val = PoofsUtil.epsilonEquals(a.DutyCycleClosedLoopRampPeriod, b.DutyCycleClosedLoopRampPeriod,TALON_CONFIG_EPSILON)
                && PoofsUtil.epsilonEquals(a.VoltageClosedLoopRampPeriod, b.VoltageClosedLoopRampPeriod,TALON_CONFIG_EPSILON)
                && PoofsUtil.epsilonEquals(a.TorqueClosedLoopRampPeriod, b.TorqueClosedLoopRampPeriod,TALON_CONFIG_EPSILON);
        if (ENABLE_LOGGING_INEQ && !val) {
    ...
    public static boolean isEqual(HardwareLimitSwitchConfigs a, HardwareLimitSwitchConfigs b) {
        boolean val = a.ForwardLimitAutosetPositionEnable == b.ForwardLimitAutosetPositionEnable
                ...
                && PoofsUtil.epsilonEquals(a.ForwardLimitAutosetPositionValue, b.ForwardLimitAutosetPositionValue,TALON_CONFIG_EPSILON)
                && PoofsUtil.epsilonEquals(a.ReverseLimitAutosetPositionValue, b.ReverseLimitAutosetPositionValue,TALON_CONFIG_EPSILON)
    ...
    public static boolean isEqual(SoftwareLimitSwitchConfigs a, SoftwareLimitSwitchConfigs b) {
        boolean val = PoofsUtil.epsilonEquals(a.ForwardSoftLimitThreshold, b.ForwardSoftLimitThreshold,TALON_CONFIG_EPSILON)
                && PoofsUtil.epsilonEquals(a.ReverseSoftLimitThreshold, b.ReverseSoftLimitThreshold,TALON_CONFIG_EPSILON)
    ...
    public static boolean isEqual(MotionMagicConfigs a, MotionMagicConfigs b) {
        boolean val = PoofsUtil.epsilonEquals(a.MotionMagicAcceleration, b.MotionMagicAcceleration,TALON_CONFIG_EPSILON)
                && PoofsUtil.epsilonEquals(a.MotionMagicCruiseVelocity, b.MotionMagicCruiseVelocity,TALON_CONFIG_EPSILON)
                && PoofsUtil.epsilonEquals(a.MotionMagicJerk, b.MotionMagicJerk,TALON_CONFIG_EPSILON);
        if (ENABLE_LOGGING_INEQ && !val) {
