...
public interface TimedLEDState {
    ...
    class RSLBasedLEDState implements TimedLEDState {
        ...
        public static RSLBasedLEDState kAutoAlign = new RSLBasedLEDState(LEDState.kOff, LEDState.kAutoAlign);
        public static RSLBasedLEDState kScore = new RSLBasedLEDState(LEDState.kOff, LEDState.kScore);
        public static RSLBasedLEDState kCubeIntakeWaiting = new RSLBasedLEDState(LEDState.kOff, LEDState.kIntakingCube);
        public static RSLBasedLEDState kConeIntakeWaiting = new RSLBasedLEDState(LEDState.kOff, LEDState.kIntakingCone);
